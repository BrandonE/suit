	...
	<div class="section">
		...
		<table class="dashboard">
			...
			<tr>
				...
				<td><iframe src="(path)suitversion=true" height="17" width="28" scrolling="no" frameborder="0"></iframe></td>
				<td class="category">(language=>currenttieversion)</td>
				<td>(currenttieversion)</td>
				<td class="category">(language=>latesttieversion)</td>
				<td><iframe src="(path)tieversion=true" height="17" width="28" scrolling="no" frameborder="0"></iframe></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><a href="(path)section=phpinfo">(language=>link)</a></td>
			</tr>
		</table>
		[/if dashboard]
		[else dashboard]
