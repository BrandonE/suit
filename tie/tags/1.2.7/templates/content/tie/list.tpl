		...
		<table class="list" cellpadding="0" cellspacing="0">
			...
			<tr class="list-entry<else file>-folder</else file>">
				...
				<td>
					...
					<else file>
					<else show><div style="visibility: hidden"></else show><input name="directoryentry\[]" type="checkbox" value="<title>"<if show><if entries_checked> checked</if entries_checked></if show> /><else show></div></else show>
					</else file>
					</else entries_code>
				</td>
				<td>
