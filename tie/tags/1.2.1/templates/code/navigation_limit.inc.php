...
if (isset($_POST['navigation_limit_submit']) && isset($_POST['navigation_limit_value']))
	$suit->tie->navigation->redirect(0, $path . 'start=0&limit=' . intval($_POST['navigation_limit_value']) . '&order=' . $suit->tie->navigation->settings['order'] . '&search=' . $suit->tie->navigation->settings['search']);
