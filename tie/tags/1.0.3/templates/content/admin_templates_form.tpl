<error>
		...
		<br /><input type="submit" name="<name>" value="<value>" tabindex="0" /> <input type="submit" name="escape" value="[escape]" tabindex="1" />
		</form>
		<br />[phpcode]:
		<br /><textarea rows="40" cols="100" wrap="off" style="width: 100%;" readonly="readonly"><code></textarea>