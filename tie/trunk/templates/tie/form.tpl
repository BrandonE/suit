        ...
        [/if]
        [/if]
        <p><label for="title">[var]language=>inputtitle[/var]</label>: <input type="text" name="title" id="title" value="[var]title[/var]"[if condition="[var]condition=>code[/var]"] readonly="readonly"[/if] /></p>
