        ...
        <p>
            ...
            [loop vars="[var]loop=>languages[/var]"]
            <option value="[loopvar]id[/loopvar]"[if condition="[loopvar]selected[/loopvar]" trim=""] selected="selected"[/if]>[loopvar]title[/loopvar]</option>
            [/loop]
            </select>
